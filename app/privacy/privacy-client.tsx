    ...
    <article className="mx-auto max-w-3xl px-4 pb-20 pt-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 rounded-[var(--radius-card)] border border-white/70 bg-white/90 p-8 shadow-[var(--shadow-card)]">
        ...
        <Section id="who-we-are" title="1. Ποιοι είμαστε">
          <p>
            Το Clyro είναι μια διαδικτυακή πλατφόρμα διαχείρισης ιατρείων που λειτουργεί από
        ...
        <Section id="data-we-collect" title="2. Δεδομένα που συλλέγουμε">
          ...
          <SubSection title="2.2 Χρήστες πλατφόρμας (my.clyroapp.com)">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li><strong>Δεδομένα χρήσης &amp; ελέγχου:</strong> συμβάντα χρήσης, αρχεία ελέγχου, αρχεία ενεργειών AI.</li>
            </ul>
            <p>
          ...
          <div className="overflow-x-auto">
            <table className="mt-2 w-full text-sm">
              ...
              <tbody className="divide-y divide-[var(--color-border)]">
                ...
                <tr>
                  <td className="py-2 pr-4">Ασφάλεια, πρόληψη απάτης, καταγραφή ελέγχου</td>
          ...
          <div className="overflow-x-auto">
            <table className="mt-2 w-full text-sm">
              ...
              <tbody className="divide-y divide-[var(--color-border)]">
                ...
                <tr>
                  <td className="py-2 pr-4">Vercel</td>
                  <td className="py-2 pr-4">Φιλοξενία &amp; CDN</td>
        ...
        <Section id="retention" title="5. Διατήρηση δεδομένων">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li><strong>Αρχεία ελέγχου:</strong> διατηρούνται για 2 χρόνια.</li>
            <li><strong>Αντίγραφα ασφαλείας:</strong> ακολουθούν το πρόγραμμα του Supabase (ανάκτηση χρονικού σημείου για 7 ημέρες).</li>
          </ul>
        </Section>
        ...
        <Section id="security" title="6. Μέτρα ασφαλείας">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>Ασφάλεια σε επίπεδο γραμμής (RLS) σε όλους τους πίνακες της βάσης δεδομένων.</li>
            <li>Αυθεντικοποίηση μέσω Clerk με υποστήριξη ελέγχου πολλαπλών παραγόντων (MFA).</li>
            <li>Προστασία τελικών σημείων API με αυθεντικοποίηση και περιορισμό αιτημάτων.</li>
            <li>Κεφαλίδες ασφαλείας (HSTS, X-Frame-Options, X-Content-Type-Options, Referrer-Policy, Permissions-Policy).</li>
