      ...
      <div className="mt-8 rounded-[var(--radius-card)] border border-white/70 bg-white/90 p-8 shadow-[var(--shadow-card)]">
        ...
        <Section id="definitions" title="2. Ορισμοί">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li><strong>&laquo;Πλατφόρμα&raquo;</strong> σημαίνει τη διαδικτυακή εφαρμογή Clyro, τα APIs και τη σχετική υποδομή.</li>
          </ul>
        </Section>
        ...
        <Section id="service-description" title="5. Περιγραφή υπηρεσίας">
          <p>
            Το Clyro παρέχει μια πλατφόρμα ηλεκτρονικού αρχείου ασθενών (EPR) και
        ...
        <Section id="acceptable-use" title="7. Αποδεκτή χρήση">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>Χρησιμοποιείτε αυτοματοποιημένες δέσμες ενεργειών χωρίς τη γραπτή μας συγκατάθεση.</li>
        ...
        <Section id="subscriptions" title="8. Συνδρομές &amp; τιμολόγηση">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li><strong>Πακέτα ανανέωσης:</strong> πρόσθετες μονάδες που δεν λήγουν ενώ η συνδρομή είναι ενεργή.</li>
        ...
        <Section id="availability" title="9. Διαθεσιμότητα &amp; υποστήριξη">
          <ul className="list-disc space-y-1 pl-5">
            <li>Στοχεύουμε σε 99.9% διαθεσιμότητα αλλά δεν εγγυόμαστε αδιάλειπτη υπηρεσία.</li>
        ...
        <Section id="ip" title="10. Πνευματική ιδιοκτησία">
          <p>
            ...
            σχεδιασμός, επωνυμία, τεκμηρίωση) παραμένουν αποκλειστική ιδιοκτησία της
        ...
        <Section id="force-majeure" title="14. Ανωτέρα βία">
          <p>
            ...
            πανδημιών, κυβερνητικών ενεργειών, διακοπών ρεύματος ή διαδικτύου.
          </p>
        </Section>
